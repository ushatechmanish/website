...
Names are intended to be used by humans for identifying resources and are unique in a namespace. They can be reused if the resource is deleted.
uids are intended to be used by kubernetes internally to identify a resource across namespace and changes everytime an object is recreated.
